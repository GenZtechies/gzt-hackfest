const faqs: any[] = [
    {
        ...
        answer: "Gen Z HackFest is an three days virtual hackathon and one day in-person conference aimed to connect Gen Z's in tech on a large scale. It's an event where ambitious Gen Z's come together to put their creative and coding skills to test and build solutions to problems in Africa and showcase what they can do!"
    },
    {
        type: "hackathon",
    ...
    },
    {
        ...
        answer: "The prizes in total worth over N1,000,000 / $2,000 in monetary and in-kind prizes. Prizes will be awarded to the top 8 projects/teams."
    },
    {
        type: "general",
