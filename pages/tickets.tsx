                ...
                <section id="get-tickets" className="flex flex-col items-center min-h-screen p-10">
                    <div className="m-auto">
                        <div className="flex flex-col gap-5 justify-center my-10">
                            <a href="" target="_blank" rel="noopener noreferrer" className="text-2xl md:text-5xl text-center rounded text-black font-black p-10 bg-primary-yellow tracking-wide">
                                Register for Hackathon →
                            </a>
                            <a href="" target="_blank" rel="noopener noreferrer" className="text-2xl md:text-5xl text-center rounded text-white font-black p-10 bg-primary-green tracking-wide">
