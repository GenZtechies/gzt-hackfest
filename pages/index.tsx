    ...
    return (
        <>
            <section className="container flex flex-col items-center mx-auto p-10">
                <h3 className="text-5xl font-bold py-5 text-center">Judges & Speakers</h3>
            ...
            <section className="container flex flex-col items-center mx-auto p-10">
                <h3 className="text-5xl font-bold py-5 text-center">Our Sponsors</h3>
            ...
            <section className="container flex flex-col items-center mx-auto p-10">
                <h3 className="text-5xl font-bold py-5 text-center">Frequently Asked Questions</h3>

                <div className="flex flex-col items-center">
                    <div className="w-full md:w-2/3">
                        <div className="flex items-center justify-between border-2 rounded-lg border-green-500 p-5 my-5">
                            <h4 className="text-2xl font-bold bg-transparent">What is HackFest ?</h4>
                            <span>
                        ...
                        <p className="text-lg">HackFest is a hackathon that is held every year in the fall. It is a great way to learn new skills and get involved in the tech community.</p>
                    </div>
                    <div className="w-full md:w-2/3">
                        <div className="flex items-center justify-between border-2 rounded-lg border-green-500 p-5 my-5">
                            <h4 className="text-2xl font-bold bg-transparent">What is the hackathon format?</h4>
                            <span>
                                <svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 2L12 12L22 2" stroke="black" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                        ...
                        <p className="text-lg">The hackathon is a 24 hour event where teams of around 5-10 people come together to build a project.</p>
                    </div>
                    <div className="w-full md:w-2/3">
                        <div className="flex items-center justify-between border-2 rounded-lg border-green-500 p-5 my-5">
                            <h4 className="text-2xl font-bold bg-transparent">What is the hackathon theme?</h4>
                            <span>
                                <svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 2L12 12L22 2" stroke="black" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                        ...
                        <p className="text-lg">The theme of the hackathon is to build a product that will help people in need.</p>
                    </div>
                </div>
            </section>

            <section className="container flex flex-col items-center mx-auto p-10">
                <h3 className="text-5xl font-bold py-5 text-center">Ready to Join Us?</h3>
                <p className="text-2xl pb-5 text-center max-w-lg">Join others and be among the first to know when we finally launch.</p>
            ...
            <footer className="container flex flex-col items-center mx-auto p-10">
                <h4 className="text-3xl font-bold py-5 text-center">Connect with us</h4>
