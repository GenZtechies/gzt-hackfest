...
import { Header, Footer, FaqAccordion } from "../../components/2022";
import { faqs, speakers, sponsors, partners, BECOME_A_SPONSOR_URL } from "../../data/2022";
            ...
            <main>
                ...
                <section id="home" className="flex flex-col items-center lg:min-h-screen p-10">
                    <div className="m-auto">
                        ...
                        <div className="flex justify-center md:justify-end items-center gap-5 mt-4 mb-10">
                            ...
                            <img src="/assets/2022/misc/companies/sailnigeria.png" className="h-14" alt="sail-logo" />
                        </div>
                        ...
                        <div className="xl:flex justify-center items-center align-middle text-md text-white text-center font-semibold mt-5">
                            <img src="/assets/2022/images/location.svg" className="h-4 md:h-7 aspect-square mx-2 my-auto inline-block" alt="location-icon" />
                            <b className="md:text-2xl">Zone Tech Park</b>
                            <span className="md:text-lg">
                                &nbsp;&mdash;{" "}
                                <a href="https://goo.gl/maps/MV8zobHyfuaVN6Y77" className="underline">
                                    Plot 9 Gbagada Industrial Scheme, Beside UPS, Gbagada Expressway, Lagos, Nigeria
                                </a>
                                .
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-5 justify-center my-10 py-10">
                            <Link href="/tickets" className="text-lg text-center text-white font-black px-6 py-3 bg-primary-purple tracking-wide border-4">
                                Register for HackFest2022 →
                            </Link>
                            <Link href="https://bit.ly/join-gzt" target="_blank" rel="noopener noreferrer" className="text-lg text-center text-white font-black px-6 py-3 bg-primary-purple tracking-wide border-4">
                                Join the Community →
                            </Link>
                        </div>
                    </div>
                ...
                <section id="video_intro" className="flex flex-col lg:min-h-screen items-center p-10">
                    <div className="my-auto w-full max-w-6xl border-4">
                        <iframe src="https://www.youtube.com/embed/YQwja2nCLnY?playlist=YQwja2nCLnY&loop=0&rel=0" title="Gen Z HacKFest 2022" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" className="w-full aspect-video" allowFullScreen data-aos="zoom-in-up"></iframe>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 m-auto gap-5">
                            <div className="my-auto max-w-2xl">
                                ...
                                <p className="text-lg md:text-2xl text-white font-bold leading-loose md:leading-loose my-5 text-justify" data-aos="fade-right">
                                    Gen Z HackFest is an annual three-day virtual hackathon and a one-day in-person conference aimed to connect Gen Z&apos;s in tech on a large scale. It&apos;s an event where ambitious Gen Z&apos;s come together to put their creative and coding skills to test, build solutions to problems in Africa and showcase what
                                    they can do!
                                </p>
                            </div>

                            <div className="my-auto -order-1 md:order-1">
                                <img src="/assets/2022/images/icon-5.svg" alt="hackathon" className="aspect-square" data-aos="zoom-in" />
                            </div>
                        </div>

                        <div className="grid grid-cols-1 lg:grid-cols-2 m-auto gap-5">
                            <div className="my-auto">
                                <img src="/assets/2022/images/icon-6.svg" alt="hackathon" className="aspect-square" data-aos="zoom-in" />
                            </div>
                            <div className="my-auto max-w-2xl">
                                ...
                                <p className="text-lg md:text-2xl text-white font-bold leading-loose md:leading-loose my-5 text-justify" data-aos="zoom-in-left">
                                    Our mission is to connect thousands of GenZ Techies in Africa to share ideas and collaborate and also connect GenZ Techies to opportunities and expose them to latest development in the technology ecosystem. We are set to achieve this through events that features workshops, talks, seminars, awareness, thus giving
